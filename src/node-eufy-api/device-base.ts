...
export abstract class AbstractDevice implements Device {
	...
	// Fix issue with lightbulb when new requests are made before previous is completed causing it to fail.
	public finishSetPreviousState = true;
	public finishGetPreviousState = true;
